 ...
 */
export function paginateMatchingProducts(matchingParents) {
  this.parentProducts = matchingParents;
  this.state.pagination.pages = paginate(matchingParents);
  ...
  return new Set(getCurrentPageItems.call(this));
}
 ...
 */
export function getMatchingParents(products, matches) {
 ...
 */
export function updatePaginationCount() {
  ...
  const perPage = itemsPerPage.call(this);
  ...
  this.stats.textContent = total ? `${start} to ${end} of ${total}` : "0 of 0";
}
...
export function renderCurrentPage() {
  ...
  const currentPageItems = new Set(getCurrentPageItems.call(this));
...
export function addPaginationButtons() {
  ...
  container.appendChild(
    _createPaginationButton.call(this, "«", "prev", "mixitup-control-prev"),
  );

  _getCondensedPages(totalPages, currentPage).forEach((page) => {
    const isFirst = page === 1;
    const isLast = page === totalPages;

    container.appendChild(
      _createPaginationButton.call(
        this,
  ...
  container.appendChild(
    _createPaginationButton.call(this, "»", "next", "mixitup-control-next"),
  );
}
 ...
 * @returns
 */
function _getCondensedPages(total, current) {
 ...
 * @returns
 */
function _createPaginationButton(label, page, extraClasses = "") {
  ...
  btn.addEventListener("click", (e) => {
    ...
    const newPage = _resolvePage.call(this, page);
